...
_Phần phụ lục phía dưới sẽ cung cấp cho mọi người một cái nhìn tổng quan về **thuật toán Luhn** - thuật toán được sử dụng để kiểm tra tính hợp lệ của các dãy số thẻ tín dụng. Thuật toán này được phát minh bởi **Hans Peter Luhn**, một kỹ sư của IBM, và đã được cấp bằng sáng chế vào năm 1960._
